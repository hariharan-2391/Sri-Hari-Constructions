...
// ─── Logo SVG ────────────────────────────────────────────────────
// A stylised house mark: pitched roof + walls + door + two windows,
// all drawn in gold on a dark pentagon background.
function LogoMark({ size = 48 }) {
  return (
    <svg width={size} height={size} viewBox="0 0 48 48" fill="none" xmlns="http://www.w3.org/2000/svg">
      {/* Background pentagon */}
      <polygon points="24,2 46,17 38,44 10,44 2,17" fill="#f5a623" opacity=".12"/>
      <polygon points="24,2 46,17 38,44 10,44 2,17" fill="none" stroke="#f5a623" strokeWidth="1.4"/>
      {/* Roof */}
      <polyline points="10,26 24,13 38,26" fill="none" stroke="#f5a623" strokeWidth="2" strokeLinejoin="round" strokeLinecap="round"/>
      {/* Chimney */}
      <rect x="30" y="15" width="3.5" height="6" fill="#f5a623" opacity=".8"/>
      {/* Walls */}
      <rect x="13" y="26" width="22" height="14" fill="#f5a623" opacity=".1" stroke="#f5a623" strokeWidth="1.4"/>
      {/* Door */}
      <rect x="21" y="32" width="6" height="8" rx="3" fill="#f5a623" opacity=".9"/>
      {/* Left window */}
      <rect x="15" y="28.5" width="4.5" height="4.5" rx=".8" fill="none" stroke="#f5a623" strokeWidth="1.2"/>
      {/* Right window */}
      <rect x="28.5" y="28.5" width="4.5" height="4.5" rx=".8" fill="none" stroke="#f5a623" strokeWidth="1.2"/>
    </svg>
  );
}
